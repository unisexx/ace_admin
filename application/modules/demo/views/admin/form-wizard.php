...
<link rel="stylesheet" href="themes/admin/media/css/select2.css" />
...
<!-- page specific plugin scripts -->
        ...
        <script src="themes/admin/media/js/fuelux.wizard.min.js"></script>
        <script src="themes/admin/media/js/jquery.validate.min.js"></script>
        <script src="themes/admin/media/js/additional-methods.min.js"></script>
        <script src="themes/admin/media/js/bootbox.min.js"></script>
        <script src="themes/admin/media/js/jquery.maskedinput.min.js"></script>
        <script src="themes/admin/media/js/select2.min.js"></script>
