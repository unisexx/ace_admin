                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <script type="text/javascript">
                                    var $path_assets = "themes/admin/media/images/";//this will be used in gritter alerts containing images
                                </script>
...
<!-- page specific plugin scripts -->
        ...
        <script src="themes/admin/media/js/bootbox.min.js"></script>
        <script src="themes/admin/media/js/jquery.easy-pie-chart.min.js"></script>
        <script src="themes/admin/media/js/jquery.gritter.min.js"></script>
        <script src="themes/admin/media/js/spin.min.js"></script>
