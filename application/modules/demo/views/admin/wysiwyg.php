...
<!-- page specific plugin scripts -->
        ...
        <script src="themes/admin/media/js/markdown.min.js"></script>
        <script src="themes/admin/media/js/bootstrap-markdown.min.js"></script>
        <script src="themes/admin/media/js/jquery.hotkeys.min.js"></script>
        <script src="themes/admin/media/js/bootstrap-wysiwyg.min.js"></script>
