    ...
    the lightweight, feature-rich and easy to use admin template.
                                                        ...
                                                        <div id="member-tab" class="tab-pane">
                                                            <div class="clearfix">
                                                                <div class="itemdiv memberdiv">
                                                                    <div class="user">
                                                                        <img alt="Bob Doe's avatar" src="themes/admin/media/images/user.jpg" />
                                                                    </div>
                                                                ...
                                                                <div class="itemdiv memberdiv">
                                                                    <div class="user">
                                                                        <img alt="Joe Doe's avatar" src="themes/admin/media/images/avatar2.png" />
                                                                    </div>
                                                                ...
                                                                <div class="itemdiv memberdiv">
                                                                    <div class="user">
                                                                        <img alt="Jim Doe's avatar" src="themes/admin/media/images/avatar.png" />
                                                                    </div>
                                                                ...
                                                                <div class="itemdiv memberdiv">
                                                                    <div class="user">
                                                                        <img alt="Alex Doe's avatar" src="themes/admin/media/images/avatar5.png" />
                                                                    </div>
                                                                ...
                                                                <div class="itemdiv memberdiv">
                                                                    <div class="user">
                                                                        <img alt="Bob Doe's avatar" src="themes/admin/media/images/avatar2.png" />
                                                                    </div>
                                                                ...
                                                                <div class="itemdiv memberdiv">
                                                                    <div class="user">
                                                                        <img alt="Phil Doe's avatar" src="themes/admin/media/images/avatar4.png" />
                                                                    </div>
                                                                ...
                                                                <div class="itemdiv memberdiv">
                                                                    <div class="user">
                                                                        <img alt="Alexa Doe's avatar" src="themes/admin/media/images/avatar1.png" />
                                                                    </div>
                                                        ...
                                                        <div id="comment-tab" class="tab-pane">
                                                            <div class="comments">
                                                                <div class="itemdiv commentdiv">
                                                                    <div class="user">
                                                                        <img alt="Bob Doe's Avatar" src="themes/admin/media/images/avatar.png" />
                                                                    </div>
        ...
        <!--[if lte IE 8]>
          <script src="themes/admin/media/js/excanvas.min.js"></script>
        <![endif]-->

        <script src="themes/admin/media/js/jquery-ui-1.10.3.custom.min.js"></script>
        <script src="themes/admin/media/js/jquery.ui.touch-punch.min.js"></script>
        <script src="themes/admin/media/js/jquery.slimscroll.min.js"></script>
        <script src="themes/admin/media/js/jquery.easy-pie-chart.min.js"></script>
        <script src="themes/admin/media/js/jquery.sparkline.min.js"></script>
        <script src="themes/admin/media/js/jquery.flot.min.js"></script>
        <script src="themes/admin/media/js/jquery.flot.pie.min.js"></script>
        <script src="themes/admin/media/js/jquery.flot.resize.min.js"></script>
