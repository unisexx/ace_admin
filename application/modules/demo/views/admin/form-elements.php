<!-- page specific plugin styles -->
        ...
        <link rel="stylesheet" href="themes/admin/media/css/jquery-ui-1.10.3.custom.min.css" />
...
<!-- page specific plugin scripts -->
        ...
        <script src="themes/admin/media/js/chosen.jquery.min.js"></script>
        <script src="themes/admin/media/js/fuelux.spinner.min.js"></script>
        <script src="themes/admin/media/js/bootstrap-datepicker.min.js"></script>
        <script src="themes/admin/media/js/bootstrap-timepicker.min.js"></script>
        <script src="themes/admin/media/js/moment.min.js"></script>
        <script src="themes/admin/media/js/daterangepicker.min.js"></script>
        <script src="themes/admin/media/js/bootstrap-colorpicker.min.js"></script>
        <script src="themes/admin/media/js/jquery.knob.min.js"></script>
        <script src="themes/admin/media/js/jquery.autosize.min.js"></script>
        <script src="themes/admin/media/js/jquery.inputlimiter.1.3.1.min.js"></script>
        <script src="themes/admin/media/js/jquery.maskedinput.min.js"></script>
        <script src="themes/admin/media/js/bootstrap-tag.min.js"></script>
