...
ace.general_things = function (a) {
    ...
    // });
    $("#ace-settings-navbar").removeAttr("checked").on("click", function () {
        if (this.checked) {
        	$("body").addClass("navbar-fixed");
            $("#navbar").addClass("navbar-fixed-top");
            if (!$("#ace-settings-navbar").get(0).checked) {
    ...
    $("#ace-settings-breadcrumbs").removeAttr("checked").on("click", function () {
        if (this.checked) {
            $("body,#breadcrumbs").addClass("breadcrumbs-fixed");
            if (!$("#ace-settings-navbar").get(0).checked) {
                $("#ace-settings-navbar").click();
            }
            if (!$("#ace-settings-sidebar").get(0).checked) {
            ...
            $("body,#breadcrumbs").removeClass("breadcrumbs-fixed");
        }
    });
    ...
    // });
    $("#ace-settings-add-container").removeAttr("checked").on("click", function () {
        if (this.checked) {
        	$(".main-container,#navbar-container").addClass('container');
            if (!$("#ace-settings-add-container").get(0).checked) {
